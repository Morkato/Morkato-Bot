...
export class BaseError extends Error {
  ...
  constructor({
    ...
    this.key = key;
    this.type = type || 'generic.unknown';
    this.databaseErrorCode = databaseErrorCode;
  }
}

export class InternalServerError extends BaseError {
  constructor({ message, action, requestId, errorId, statusCode, type, errorLocationCode }: ErrorParams) {
    super({
...
export class NotFoundError extends BaseError {
  constructor({ message, action, type, requestId, errorId, errorLocationCode, key }: ErrorParams) {
    super({
...
export class ServiceError extends BaseError {
  constructor({ message, action, type, statusCode, errorLocationCode, databaseErrorCode }: ErrorParams) {
    super({
...
export class ValidationError extends BaseError {
  constructor({ message, action, type, statusCode, errorLocationCode, key }: ErrorParams) {
    super({
...
export class UnauthorizedError extends BaseError {
  constructor({ message, action, type, requestId, errorLocationCode }: ErrorParams) {
    super({
...
export class TooManyRequestsError extends BaseError {
  constructor({ message, action, type, errorLocationCode }: ErrorParams) {
    super({
