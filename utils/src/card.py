...
heart_icon = Editor("assets/ico/life.png")
ring_icon  = Editor("assets/ico/ring.png")
human_icon = Editor("assets/ico/human.png")
hybrid_icon = Editor("assets/ico/hybrid.png")
oni_icon = Editor("assets/ico/oni.png")
blood_icon = Editor("assets/ico/blood.png")
breath_icon = Editor("assets/ico/breath.png")
...
bigroboto = ImageFont.FreeTypeFont('assets/fonts/Roboto-Bold.ttf', 26)
mediumroboto = ImageFont.FreeTypeFont('assets/fonts/Roboto-Bold.ttf', 12)
smallroboto = ImageFont.FreeTypeFont('assets/fonts/Roboto-Bold.ttf', 10)

bigbigroboto = ImageFont.FreeTypeFont('assets/fonts/Roboto-Bold.ttf', bigroboto.size * BIG_SIZE)
bigmediumroboto = ImageFont.FreeTypeFont('assets/fonts/Roboto-Bold.ttf', mediumroboto.size * BIG_SIZE)
bigsmallroboto = ImageFont.FreeTypeFont('assets/fonts/Roboto-Bold.ttf', smallroboto.size * BIG_SIZE)
...
def card_headers(*,
  ...
  avatar       = create_avatar(avatar_image)
